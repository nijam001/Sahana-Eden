...
def location():
    ...
    from core import TextFilter, OptionsFilter#, LocationFilter
    search_fields = ["name",
                     "comments",
                     "tag.value",
                     ]
    ...
    for level, level_label in location_hierarchy.items():
        ...
        filter_level_widgets.append(OptionsFilter(level,
                                                  label = level_label,
                                                  #cols = 5,
                                                  hidden = hidden,
                                                  ))
    ...
    if get_vars.get("~.level") != "None":
        filter_widgets.append(OptionsFilter("level",
                                            label = T("Level"),
